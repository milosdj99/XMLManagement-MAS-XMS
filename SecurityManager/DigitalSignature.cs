...
namespace SecurityManager
{
    ...
    public class DigitalSignature
    {
		...
		public static byte[] Create(string alarm, HashAlgorithm hashAlgorithm, X509Certificate2 certificate)
        {
        ...
        public static bool Verify(string por, HashAlgorithm hashAlgorithm, byte[] signature, X509Certificate2 certificate)
        {
            ...
            UnicodeEncoding encoding = new UnicodeEncoding();
            byte[] data = encoding.GetBytes(por);
